...
def create_dcostate_object(dco_id):
    ...
    dco_state.hal.dco_capabilities.SupportedClient.name = "client-1"
    dco_state.hal.dco_capabilities.SupportedClient.band_width = 1
    
    dco_state.hal.dco_capabilities.SupportedLineMode.application_code = "line_app_code_1"
    dco_state.hal.dco_capabilities.SupportedLineMode.client_mode = 2
